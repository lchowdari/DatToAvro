 ...
 * 
 */
public class DatToAvroGenericWriter
{
	 ...
	 * @throws Exception
	 */
	public DatToAvroGenericWriter(Schema schema, String outputFileName, int mode) throws Exception
	{
		this.avroSchema = schema;
	    this.outputFileName = outputFileName;
	    DatToAvroGenericWriter.mode = mode;
	 ...
	 * @throws Exception
	 */
	public DatToAvroGenericWriter(Schema schema, String outputFileName, int mode, int compressionFactor) throws Exception
	{
		this.avroSchema = schema;
	    this.outputFileName = outputFileName;
	    DatToAvroGenericWriter.mode = mode;
	 ...
	 * @throws Exception
	 */
	public DatToAvroGenericWriter(String jsonSchema, String outputFileName, int mode) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public DatToAvroGenericWriter(File jsonSchemaFile, String outputFileName, int mode) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public DatToAvroGenericWriter(String jsonSchema, String outputFileName, int mode, int compressionFactor) throws Exception
	{
