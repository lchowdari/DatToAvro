 ...
 * 
 */
public class DatToAvroWriter<T extends SpecificRecord>
{
	 ...
	 * @throws Exception
	 */
	public DatToAvroWriter(Schema schema, String outputFileName, int mode) throws Exception
	{
		this.avroSchema = schema;
	    this.outputFileName = outputFileName;
	    DatToAvroWriter.mode = mode;
	 ...
	 * @throws Exception
	 */
	public DatToAvroWriter(File schemaFile, String outputFileName, int mode) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public DatToAvroWriter(Schema schema, String outputFileName, int mode, int compressionFactor) throws Exception
	{
		this.avroSchema = schema;
	    this.outputFileName = outputFileName;
	    DatToAvroWriter.mode = mode;
	 ...
	 * @throws Exception
	 */
	public DatToAvroWriter(String jsonSchema, String outputFileName, int mode, int compressionFactor) throws Exception
	{
